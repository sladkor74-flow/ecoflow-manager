...
//
// Specchio del backend: base44/shared/proiezioneSecondarie.ts. Le pagine oggi
// non lo importano (i numeri arrivano dalle funzioni), ma resta identico
// all'originale perche' e' la stessa regola: se una pagina lo usera', trovera'
// il conto giusto.
import { eTerminato, periodoMovimento, canaleMovimento, dateDaSistemare, testoDate } from '@/lib/movimenti';
import { formatKg as formatoKg, formatTonnellate as formatoTonnellate } from '@/lib/utils';
