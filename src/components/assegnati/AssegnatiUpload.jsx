...
export default function AssegnatiUpload({ onImported }) {
  ...
  return (
    <div className="border-2 border-dashed rounded-lg p-6 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-heading font-semibold">Importa estratto Assegnati dal portale Ecotyre</h3>
      </div>
      <p className="text-sm text-muted-foreground">
        Carica il file Excel con i dati a partire dalla cella A1. Vengono processati esclusivamente i record con <strong>Stato = "assegnato"</strong> (Colonna B).
        Le colonne derivate (Regione, Mese, Classe PFU, Anno) vengono calcolate automaticamente.
      </p>
      <input
        ref={inputRef}
        type="file"
