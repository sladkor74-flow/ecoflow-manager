...
export const BASE_CONOSCENZA: VoceConoscenza[] = [
  ...
  {
    id: 'rentri-produttori-non-iscritti', area: 'rentri', verificato_il: '2026-09-17',
    titolo: 'Gommisti e produttori non iscritti al RENTRI',
    testo: 'I soggetti esclusi dall\'obbligo di iscrizione (art. 190 c. 5 e 6 del D.Lgs. 152/2006), come i gommisti con non piu\' di dieci dipendenti che producono PFU non pericolosi, emettono il FIR solo in formato cartaceo, vidimato digitalmente tramite il RENTRI, e non trasmettono al RENTRI i dati dei formulari (FAQ RENTRI del 13 gennaio 2026). Quindi dal 16 settembre 2026 le primarie da questi punti di raccolta restano su FIR cartaceo vidimato anche se il trasportatore e\' iscritto, mentre i trasporti tra soggetti iscritti, come le secondarie da stoccaggio a impianto, vanno con FIR digitale. Il trasportatore concorda prima del ritiro tipo di formulario, firme e strumenti. Per la direzione SMOCO, da dieci dipendenti in su il FIR va comunque fatto in digitale (vedi la voce sul FIR digitale).',
    fonti: ['FAQ RENTRI 13 gennaio 2026', 'https://www.rentri.gov.it/area-produttori-di-rifiuti-non-iscritti', 'D.Lgs. 152/2006 art. 190', 'Precisazione della direzione SMOCO del 17/09/2026'],
  },
